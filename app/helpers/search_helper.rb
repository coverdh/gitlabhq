module SearchHelper
  ...
  def help_autocomplete
    [
      ...
      { category: "帮助", label: "Rake Tasks 帮助",    url: help_page_path("raketasks/README") },
      { category: "帮助", label: "SSH密钥帮助",      url: help_page_path("ssh/README") },
      { category: "帮助", label: "系统钩子帮助",  url: help_page_path("system_hooks/system_hooks") },
      { category: "帮助", label: "Webhooks帮助",      url: help_page_path("web_hooks/web_hooks") },
